import { ContractFactory, Interface, Contract, ethers } from 'ethers';
...
class Web3Site__factory extends ContractFactory {
    constructor(...args) {
...
class WTTPGatewayV3__factory extends ContractFactory {
    constructor(...args) {
        if (isSuperArgs(args)) {
            super(...args);
        }
...
export { WTTP_VERSION, fetch, formatEthereumAddress, getHostAddress, getNetworkAlias, getWttpProvider, getWttpUrl, initWttpHandler, loadWttpGateway, loadWttpHost, mockWttpGet, resolveEnsName, wttpGet, wttpHead };
